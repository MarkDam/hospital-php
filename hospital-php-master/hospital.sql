...
(1, 'Bobbie', 'male', 1, 1,'Koorts, eet slecht, blaft veel te veel'),
(2, 'Minoes', 'female', 2, 2,'Drinkt niet, haaruitval, mager'),
(3, 'Kees', 'male', 1, 2,'Eet te veel, vetzucht, jankt en kotst');
